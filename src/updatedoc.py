...
class UpdateDocPage(QWidget):
    ...
    def update_one(self):
        ...
        filter_text=unicode(self.filter_edit.toPlainText().toUtf8(),
                'utf8','ignore')
        update_text=unicode(self.update_edit.toPlainText().toUtf8(),
                'utf8','ignore')
    ...
    def update_many(self):
        ...
        filter_text=unicode(self.filter_edit.toPlainText())
        update_text=unicode(self.update_edit.toPlainText())
