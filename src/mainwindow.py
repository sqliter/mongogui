...
class MainWindow(QMainWindow):
    ...
    def server_info(self):
        ...
        if current.type()==MainWindow.c_server_node:
            server=unicode(current.text(0).toUtf8(),'utf-8','ignore')
    ...
    def remove_db(self):
        ...
        client=MongoClient()
        dbname=unicode(current.text(0).toUtf8(),'utf-8','ignore')
    ...
    def remove_coll(self):
        ...
        if current.type()==MainWindow.c_coll_node:
            coll_name=unicode(current.text(0).toUtf8(),'utf-8','ignore')
            db_name=unicode(
    ...
    def refresh_collections(self,db_item):
        ...
        for index in range(count):
            ...
            if child.type()==MainWindow.c_coll_folder_node:
                ...
                mongo=MongoClient()
                dbname=unicode(db_item.text(0).toUtf8(),
                        'utf-8','ignore')
                db=mongo[dbname]
